...
function printStyle() {
	...
	res += '  .ngaythang {background-color:#FDFDF0;border:2px solid;}\n';
	res += '  .ngaythang:hover {background-color:#CCFFCC;cursor:pointer;}\n';
...
function printTable(mm, yy) {
	...
	var res = "";
	res += ('<table class="thang" style="background-color:#7C99AA;" cellpadding="1" cellspacing="1" width="' + PRINT_OPTS.tableWidth + '">\n');
	res += printHead(mm, yy);
	for (i = 0; i < 6; i++) {
		res += ("<tr>\n");
		for (j = 0; j < 7; j++) {
...
function printHead(mm, yy) {
	...
	res += ('<tr><td colspan="1" class="navi-l" title="Nam tru?c">' + getPrevYearLink(mm, yy) + '</td>\n');
	res += ('<td colspan="1" class="navi-l" title="Tháng tru?c">' + getPrevMonthLink(mm, yy) + '</td>\n');
	//res += ('<td colspan="1" class="navig"><a href="'+getPrevMonthLink(mm, yy)+'"><img src="left1.gif" alt="Prev"></a></td>\n');
	res += ('<td colspan="3" class="tenthang" onClick="showMonthSelect();">'+monthName+'</td>\n');
	//res += ('<td colspan="1" class="navi-r"><a href="'+getNextMonthLink(mm, yy)+'"><img src="right1.gif" alt="Next"></a></td>\n');
	res += ('<td colspan="1" class="navi-r" title="Tháng sau">' + getNextMonthLink(mm, yy) + '</td>\n');
    res += ('<td colspan="1" class="navi-r" title="Nam sau">'+getNextYearLink(mm, yy)+'</td></tr>\n');
	//res += ('<tr><td colspan="7" class="tenthang"><a href="'+getNextMonthLink(mm, yy)+'"><img src="right.gif" alt="Next"></a></td></tr>\n');
	res += ('<tr onClick="alertAbout();">\n');
	for (var i = 0; i <= 6; i++) {
	    if (DAYNAMES[i] == 'CN') {
	        res += ('<td class=ngaytuan style="color:red">' + DAYNAMES[i] + '</td>\n');
         }
	    else {
...
function showMonthSelect() {
	var home = "http://www.dophuquy.com";
